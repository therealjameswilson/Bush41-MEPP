window.MEPP_COMPILER_GAPS = [
  ...
  },
  {
    ...
    "status": "Remediated for triage: 165 presidential PDFs counted, 1060 source candidates carry review metadata, 72 source-candidate digital objects have page/image counts, and 932 PDF folder scans are explicitly flagged for manual review.",
  ...
  },
  {
    ...
    "status": "Remediated for triage: 552 source candidates harvested across presidential, Haass, Baker, WHORM/search, and gap-remediation lanes; indirect Palestinian contacts still require document-level confirmation.",
  ...
  },
  {
    ...
    "chapter": "All chapters",
    "status": "Remediated to triage standard: presidential records and source candidates include normalized source-note fields plus review metadata; 0 source-candidate review errors are flagged explicitly.",
